...
function changeName(arr) {
  return arr[8].name = 'Vincent Van Gogh';
}
...
console.log(addArtist(artists, 21, 'Juan', '2001 - 20', 'Web Design', 'American', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'))
