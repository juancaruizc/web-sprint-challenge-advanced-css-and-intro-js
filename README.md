...
- Acessiblity is programming so every type of person can access a site no matter the disability.

2. Talk about 3 different things you can do to ensure your website is accessible. 
- descriptive alt tags
- Correct color scheme in design
- Responsive design

3. How would you explain the concept of a variable to someone new to programming?
- A variable is a value that holds data that can change
4. What is the purpose of using functions in code?
- Functions are like mini programs that when invokes/triggered make a functionality that one sets it to. It allows the program to do whatever one sets it to.
